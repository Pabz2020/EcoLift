...
class WasteTypeSelection extends StatefulWidget {
  const WasteTypeSelection({super.key});

  @override
  State<WasteTypeSelection> createState() => _WasteTypeSelectionState();
}

class _WasteTypeSelectionState extends State<WasteTypeSelection>
