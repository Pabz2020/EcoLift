...
const AdminDashboard = () => {
    ...
    const mockRecentActivity = [
        { id: 1, user: 'John Doe', action: 'New registration', time: '2 minutes ago', type: 'success' },
        { id: 2, user: 'Jane Smith', action: 'Profile updated', time: '5 minutes ago', type: 'info' },
        { id: 3, user: 'Mike Johnson', action: 'Payment completed', time: '10 minutes ago', type: 'success' },
        { id: 4, user: 'Sarah Wilson', action: 'Account suspended', time: '15 minutes ago', type: 'warning' }
    ];
        ...
        <div className="admin-dashboard">
            ...
            <Box className="dashboard-content">
                <Container maxWidth="xl">
                    ...
                    {/* Recent Activity */}
                    <Grid container spacing={3} className="activity-section">
                        <Grid item xs={12} md={6}>
                            <Paper className="activity-card" elevation={0}>
                                <Box className="card-header">
                                    <Typography variant="h6" className="card-title">
                                        Recent Activity
                                    </Typography>
                                    <Button variant="text" size="small" className="view-all-button">
                                        View All
                                    </Button>
                                </Box>
